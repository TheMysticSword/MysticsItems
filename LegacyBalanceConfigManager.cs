...
namespace MysticsItems
{
    public static class LegacyBalanceConfigManager
    {
        ...
        {
            public ConfigurableValue(string section, string key, float defaultValue, string description = "", List<string> stringsToAffect = null, bool restartRequired = false, EventHandler onChanged = null) : base(ConfigManager.Balance.config, section, key, (T)Convert.ChangeType(defaultValue, typeof(T)), description, stringsToAffect, ConfigManager.Balance.enabled.bepinexConfigEntry, restartRequired, onChanged)
            {
            ...
            public ConfigurableValue(string section, string key, int defaultValue, string description = "", List<string> stringsToAffect = null, bool restartRequired = false, EventHandler onChanged = null) : base(ConfigManager.Balance.config, section, key, (T)Convert.ChangeType(defaultValue, typeof(T)), description, stringsToAffect, ConfigManager.Balance.enabled.bepinexConfigEntry, restartRequired, onChanged)
            {
            ...
            public ConfigurableValue(string section, string key, bool defaultValue, string description = "", List<string> stringsToAffect = null, bool restartRequired = false, EventHandler onChanged = null) : base(ConfigManager.Balance.config, section, key, (T)Convert.ChangeType(defaultValue, typeof(T)), description, stringsToAffect, ConfigManager.Balance.enabled.bepinexConfigEntry, restartRequired, onChanged)
            {
