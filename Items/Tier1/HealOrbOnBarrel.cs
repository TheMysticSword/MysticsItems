...
namespace MysticsItems.Items
{
    public class HealOrbOnBarrel : BaseItem
    {
        public override void PreAdd()
        {
            ...
            this.itemDef.tier = ItemTier.Tier1;
            this.itemDef.tags = new ItemTag[]
            {
                ItemTag.Healing,
                ItemTag.Utility,
                ItemTag.AIBlacklist
            ...
            AddDisplayRule("mdlToolbot", "Head", new Vector3(0.053F, 2.57F, 1.265F), new Vector3(55.266F, 359.983F, 0.119F), new Vector3(1.5F, 1.5F, 1.5F));
            AddDisplayRule("mdlEngi", "HeadCenter", new Vector3(0F, 0.131F, -0.014F), new Vector3(356.315F, 0.001F, 359.976F), new Vector3(0.175F, 0.175F, 0.175F));
            AddDisplayRule((int)Main.CommonBodyIndices.EngiTurret, "Head", new Vector3(0F, 0.548F, 0F), new Vector3(0F, 180F, 0F), new Vector3(1.447F, 1.447F, 1.447F));
            AddDisplayRule((int)Main.CommonBodyIndices.EngiWalkerTurret, "Head", new Vector3(0F, 1.13F, -1.52F), new Vector3(351.692F, 180F, 0F), new Vector3(0.684F, 0.399F, 0.478F));
            AddDisplayRule("mdlMage", "Head", new Vector3(0F, 0.112F, -0.121F), new Vector3(66.476F, 180F, 0F), new Vector3(0.149F, 0.149F, 0.149F));
            AddDisplayRule("mdlMerc", "Chest", new Vector3(0.013F, 0.184F, -0.259F), new Vector3(71.925F, 180F, 0F), new Vector3(0.15F, 0.15F, 0.15F));
            AddDisplayRule("mdlTreebot", "HandL", new Vector3(0.055F, 0.638F, 0.354F), new Vector3(12.464F, 0.568F, 10.583F), new Vector3(0.315F, 0.315F, 0.315F));
            AddDisplayRule("mdlLoader", "Head", new Vector3(0F, 0.231F, 0F), new Vector3(0F, 180F, 0F), new Vector3(0.15F, 0.15F, 0.15F));
            AddDisplayRule("mdlCroco", "Head", new Vector3(-0.946F, 3.963F, -0.229F), new Vector3(279.836F, 0F, 170.118F), new Vector3(1.602F, 1.602F, 1.602F));
            AddDisplayRule("mdlCaptain", "Stomach", new Vector3(0.002F, 0.134F, 0.176F), new Vector3(313.466F, 271.294F, 278.969F), new Vector3(0.086F, 0.086F, 0.086F));
            AddDisplayRule("mdlBrother", "Head", BrotherInfection.white, new Vector3(-0.01F, 0.044F, 0.12F), new Vector3(65.585F, 339.303F, 255.053F), new Vector3(0.107F, 0.107F, 0.107F));
        }
            ...
            On.EntityStates.Barrel.Opening.OnEnter += (orig, self) =>
            {
                ...
                if (gameObject)
                {
                    ...
                    if (spawnOrbOnBarrelOpen && spawnOrbOnBarrelOpen.interactor) {
                        ...
                        if (interactorBody) {
                            SpawnOrb(gameObject.transform.position, gameObject.transform.rotation, interactorBody.teamComponent.teamIndex, interactorBody.inventory.GetItemCount(itemIndex));
                        }
