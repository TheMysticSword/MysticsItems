    ...
    public class MarwanAsh1 : BaseItem
    {
        ...
        public override void OnLoad()
        {
            ...
            onSetupIDRS += () =>
            {
                ...
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysDeputy) AddDisplayRule("DeputyBody", "ShoulderR", new Vector3(-0.00001F, 0.12511F, 0.06011F), new Vector3(292.5731F, 287.6386F, 250.9993F), new Vector3(0.05829F, 0.05829F, 0.05829F));
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysChirr) AddDisplayRule("ChirrBody", "Chest", new Vector3(-0.32611F, 0.70175F, 0.39351F), new Vector3(11.63338F, 220.4631F, 345.9714F), new Vector3(0.15391F, 0.15391F, 0.15391F));
