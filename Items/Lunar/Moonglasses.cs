    ...
    public class Moonglasses : BaseItem
    {
        ...
        public override void OnLoad()
        {
            ...
            onSetupIDRS += () =>
            {
                ...
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysDeputy) AddDisplayRule("DeputyBody", "Head", new Vector3(0.00001F, 0.12964F, 0.09561F), new Vector3(354.2887F, 180F, 0F), new Vector3(4.00125F, 4.00125F, 4.00125F));
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysChirr) AddDisplayRule("ChirrBody", "Head", new Vector3(0F, 0.39438F, 0.23379F), new Vector3(79.08691F, 0F, 0F), new Vector3(12.15009F, 12.15009F, 12.15009F));
