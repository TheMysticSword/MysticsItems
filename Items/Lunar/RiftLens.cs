    ...
    public class RiftLens : BaseItem
    {
        ...
        public override void OnLoad()
        {
            ...
            onSetupIDRS += () =>
            {
                ...
                {
                    AddDisplayRule("DeputyBody", "RevolverL", new Vector3(0F, 0.41804F, -0.04883F), new Vector3(90F, 0F, 0F), new Vector3(0.01301F, 0.01301F, 0.01301F));
                    AddDisplayRule("DeputyBody", "RevolverR", new Vector3(0F, 0.41804F, -0.04883F), new Vector3(90F, 0F, 0F), new Vector3(0.01301F, 0.01301F, 0.01301F));
                }
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysChirr) AddDisplayRule("ChirrBody", "Head", new Vector3(0.52395F, 0.31247F, 0.10468F), new Vector3(30.85513F, 269.9384F, 195.4554F), new Vector3(0.13036F, 0.13036F, 0.13036F));
            ...
            {
                MysticsItemsRiftChest.wallPrefab = Addressables.LoadAssetAsync<GameObject>("RoR2/Base/Mage/MageIcewallPillarProjectile.prefab").WaitForCompletion();

                MysticsItemsRiftChest.boltPrefabs.Add(Addressables.LoadAssetAsync<GameObject>("RoR2/Base/Mage/MageFireboltBasic.prefab").WaitForCompletion());
                MysticsItemsRiftChest.boltPrefabs.Add(Addressables.LoadAssetAsync<GameObject>("RoR2/Base/Mage/MageLightningboltBasic.prefab").WaitForCompletion());
                MysticsItemsRiftChest.boltPrefabs.Add(Addressables.LoadAssetAsync<GameObject>("RoR2/Base/ArtifactShell/ArtifactShellSeekingSolarFlare.prefab").WaitForCompletion());
                MysticsItemsRiftChest.boltPrefabs.Add(Addressables.LoadAssetAsync<GameObject>("RoR2/Base/GreaterWisp/WispCannon.prefab").WaitForCompletion());
                MysticsItemsRiftChest.boltPrefabs.Add(Addressables.LoadAssetAsync<GameObject>("RoR2/Base/Vagrant/VagrantCannon.prefab").WaitForCompletion());
                // MysticsItemsRiftChest.boltPrefabs.Add(Addressables.LoadAssetAsync<GameObject>("RoR2/Base/Titan/TitanRockProjectile.prefab").WaitForCompletion());
                MysticsItemsRiftChest.boltPrefabs.Add(Addressables.LoadAssetAsync<GameObject>("RoR2/Base/LunarExploder/LunarExploderShardProjectile.prefab").WaitForCompletion());
                MysticsItemsRiftChest.boltPrefabs.Add(Addressables.LoadAssetAsync<GameObject>("RoR2/Base/LemurianBruiser/LemurianBigFireball.prefab").WaitForCompletion());
                MysticsItemsRiftChest.boltPrefabs.Add(Addressables.LoadAssetAsync<GameObject>("RoR2/Base/Lemurian/Fireball.prefab").WaitForCompletion());
                MysticsItemsRiftChest.boltPrefabs.Add(Addressables.LoadAssetAsync<GameObject>("RoR2/Base/RoboBallBoss/RoboBallProjectile.prefab").WaitForCompletion());
                    ...
                    if (riftShooterBody != null)
                    {
                        ...
                        if (boltTimer <= 0f)
                        {
                            ...
                            for (var i = 0; i < boltUpCount; i++)
                            {
                                ...
                                currentRotation *= Quaternion.AngleAxis(upAngleDelta, Vector3.left);
                            }

                            boltRotation *= Quaternion.AngleAxis(360f / boltCount, Vector3.up);

                            boltCurrentCycleCount++;
