    ...
    public class JudgementCut : BaseItem
    {
        ...
        public override void OnLoad()
        {
            ...
            onSetupIDRS += () =>
            {
                ...
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysDeputy) AddDisplayRule("DeputyBody", "Pelvis", new Vector3(0.17051F, 0.01166F, -0.02439F), new Vector3(11.50627F, 96.42719F, 233.0675F), new Vector3(1F, 1F, 1F));
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysChirr) AddDisplayRule("ChirrBody", "Chest", new Vector3(-0.35372F, -0.03451F, -0.10522F), new Vector3(353.3962F, 270.1915F, 20.61756F), new Vector3(1.89867F, 1.89867F, 1.89867F));
