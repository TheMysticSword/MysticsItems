    ...
    public class ExplosivePickups : BaseItem
    {
        ...
        public override void OnLoad()
        {
            ...
            onSetupIDRS += () =>
            {
                ...
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysDeputy) AddDisplayRule("DeputyBody", "Pelvis", new Vector3(-0.13521F, -0.03464F, -0.04488F), new Vector3(3.34181F, 56.42193F, 185.0183F), new Vector3(0.04065F, 0.04065F, 0.04065F));
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysChirr) AddDisplayRule("ChirrBody", "Chest", new Vector3(-0.10143F, -0.32908F, -0.37538F), new Vector3(9.94634F, 21.79128F, 16.56317F), new Vector3(0.11997F, 0.11997F, 0.11997F));
