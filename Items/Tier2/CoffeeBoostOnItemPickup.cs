    ...
    public class CoffeeBoostOnItemPickup : BaseItem
    {
        ...
        public override void OnLoad()
        {
            ...
            onSetupIDRS += () =>
            {
                ...
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysDeputy) AddDisplayRule("DeputyBody", "HandL", new Vector3(-0.03877F, 0.07957F, -0.14052F), new Vector3(335.7827F, 1.17915F, 87.12741F), new Vector3(0.07323F, 0.07323F, 0.07323F));
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysChirr) AddDisplayRule("ChirrBody", "Head", new Vector3(0.59485F, -0.48705F, 0.03932F), new Vector3(352.5744F, 355.7956F, 276.9978F), new Vector3(0.17332F, 0.17332F, 0.17332F));
