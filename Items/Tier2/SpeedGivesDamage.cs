    ...
    public class SpeedGivesDamage : BaseItem
    {
        ...
        public override void OnLoad()
        {
            ...
            onSetupIDRS += () =>
            {
                ...
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysDeputy) AddDisplayRule("DeputyBody", "CalfL", new Vector3(-0.00663F, 0.20217F, -0.0857F), new Vector3(272.641F, 189.2938F, 170.5175F), new Vector3(0.04373F, 0.04373F, 0.04373F));
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysChirr) AddDisplayRule("ChirrBody", "FootB", new Vector3(0F, -1.39569F, 0.21788F), new Vector3(272.5772F, 193.9956F, 346.018F), new Vector3(0.0549F, 0.1911F, 0.07903F));
