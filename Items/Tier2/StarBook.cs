    ...
    public class StarBook : BaseItem
    {
        ...
        public override void OnLoad()
        {
            ...
            onSetupIDRS += () =>
            {
                ...
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysDeputy) AddDisplayRule("DeputyBody", "Pelvis", new Vector3(0.08353F, -0.0004F, -0.05345F), new Vector3(7.60901F, 152.449F, 181.1016F), new Vector3(0.03191F, 0.03191F, 0.03191F));
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysChirr) AddDisplayRule("ChirrBody", "Chest", new Vector3(0.36544F, -0.12116F, -0.03546F), new Vector3(359.9014F, 102.5638F, 107.8644F), new Vector3(0.05578F, 0.05578F, 0.05578F));
