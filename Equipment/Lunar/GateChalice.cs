    ...
    public class GateChalice : BaseEquipment
    {
        ...
        public override void OnLoad()
        {
            ...
            onSetupIDRS += () =>
            {
                ...
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysDeputy) AddDisplayRule("DeputyBody", "ThighR", new Vector3(-0.04099F, 0.18916F, 0.12788F), new Vector3(342.0172F, 331.6853F, 159.8084F), new Vector3(0.05205F, 0.05205F, 0.05205F));
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysChirr) AddDisplayRule("ChirrBody", "Stomach", new Vector3(0F, 0.14763F, 0.65398F), new Vector3(35.42088F, 0F, 0F), new Vector3(0.11977F, 0.11977F, 0.11977F));
