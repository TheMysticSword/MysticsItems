    ...
    public class PrinterHacker : BaseEquipment
    {
        ...
        public override void OnLoad()
        {
            ...
            onSetupIDRS += () =>
            {
                ...
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysDeputy) AddDisplayRule("DeputyBody", "Pelvis", new Vector3(-0.13307F, -0.00978F, 0.00196F), new Vector3(27.56701F, 172.3847F, 170.133F), new Vector3(0.03133F, 0.03133F, 0.03133F));
                if (SoftDependencies.SoftDependenciesCore.itemDisplaysChirr) AddDisplayRule("ChirrBody", "Head", new Vector3(0.62637F, -0.22955F, 0.19958F), new Vector3(356.8505F, 180F, 180F), new Vector3(0.09649F, 0.09649F, 0.09649F));
